...
test('should open a 530 gmd file (pathtracer.gmd)', function(t) {
        // this.timeout(25000);
    ...
    _.each(gm6_files, function(gm_file) {
        test(`should open a gm6 (600) file (${gm_file})`, function(t) {
            // this.timeout(50000);
    ...
    _.each(gm7_files, function(gm_file) {
        ...
        test(`should open a gm7 (701) obfuscated file (${gm_file})`, function(t) {
        // this.timeout(50000);
        var file_path = `./tests/gm_files/${gm_file}`;
        var gmk_file = GMFileReader.openGmFile(file_path);
...
var gm8_files = ["fpsexample.gmk", "Tetris.gmk"];
 _.each(gm8_files, function(gm_file) {
    test(`should open a gm8 (800) compressed file (${gm_file})`, function(t) {
        // this.timeout(25000);
        var file_path = `./tests/gm_files/${gm_file}`;
        var gmk_file = GMFileReader.openGmFile(file_path);
